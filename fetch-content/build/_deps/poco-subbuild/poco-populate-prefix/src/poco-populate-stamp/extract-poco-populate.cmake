...
#
get_filename_component(filename "C:/opengl/fetch-content/build/_deps/poco-subbuild/poco-populate-prefix/src/poco-1.12.4-release.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/opengl/fetch-content/build/_deps/poco-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-poco-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-poco-populate${i}")
